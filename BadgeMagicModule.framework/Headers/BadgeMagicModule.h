...
@class BMMMessage, BMMDataToSend, BMMSpeed, BMMMode, BMMKotlinEnum, BMMKotlinByteArray, BMMKotlinByteIterator, BMMKotlinArray, BMMKotlinx_serialization_runtimeSerialKind, BMMKotlinNothing, BMMKotlinx_serialization_runtimeUpdateMode;

@protocol BMMKotlinx_serialization_runtimeKSerializer, BMMKotlinComparable, BMMKotlinx_serialization_runtimeEncoder, BMMKotlinx_serialization_runtimeSerialDescriptor, BMMKotlinx_serialization_runtimeSerializationStrategy, BMMKotlinx_serialization_runtimeDecoder, BMMKotlinx_serialization_runtimeDeserializationStrategy, BMMKotlinx_serialization_runtimeCompositeEncoder, BMMKotlinx_serialization_runtimeSerialModule, BMMKotlinAnnotation, BMMKotlinx_serialization_runtimeCompositeDecoder, BMMKotlinIterator, BMMKotlinx_serialization_runtimeSerialModuleCollector, BMMKotlinKClass, BMMKotlinKDeclarationContainer, BMMKotlinKAnnotatedElement, BMMKotlinKClassifier;
